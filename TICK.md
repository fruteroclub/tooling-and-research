...
|-------|------|------|--------|------------|-------------|-------------|
| @codex | bot | engineer | idle | - | 2026-07-24T11:01:33.915Z | trusted |
...
history:
  ...
  - ts: 2026-07-24T10:30:14.096Z
    ...
    from: backlog
    to: in_progress
  - ts: 2026-07-24T10:35:55.180Z
    who: "@codex"
    action: commented
    note: "Replaced the Hermes guide with a direct config-extension runbook: backup
      ~/.hermes config, add NEBIUS_API_KEY to ~/.hermes/.env, add
...
updated_at: 2026-07-24T11:01:33.915Z
tags:
  - hermes
  - nebius-token-factory
  - docs
